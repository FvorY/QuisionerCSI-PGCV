			...
			<div class="panel-body">
				<table id="tablekonten" class="table table-striped table-bordered table-responsive" style="">
					<thead>
						...
						<th width="1%">
							<div id="konten">Kategory Id</div>
						</th>
						<th width="1%">
							<div id="konten">Variabel</div>
						</th>
						<th width="10%">
							<div id="konten">Pertanyaan</div>
						</th>
					...
					<tbody>
						...
						?>
							<tr>
								...
								<td>
									<div id="kontentd"><?php echo $data['categoryId']; ?></div>
								</td>
								<td>
									<div id="kontentd"><?php echo $data['variabelName']; ?></div>
								</td>
								<td>
									<div id="kontentd"><?php echo $data['question']; ?></div>
								</td>
